...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " stephanpower-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  stephanpower-tx [options] <hex-tx> [commands]  Update hex-encoded stephanpower transaction\n" +
            "or:     stephanpower-tx [options] -create [commands]   Create hex-encoded stephanpower transaction\n" +
            "\n";
