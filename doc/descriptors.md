# Support for Output Descriptors in Stephanpower Core

Since Stephanpower Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `nsp1...` for mainnet or `tnsp1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Stephanpower's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Stephanpower Core wallets, a convenience function `combo` is
