...
bech32_templates = [
  ...
  ('nsp',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('nsp',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('nsp',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tnsp',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tnsp',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tnsp',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rnsp',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rnsp',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rnsp', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tnsp',  17, 32, False, False, False),
  ('rnsp',  3,  1, False, False, False),
  ('nsp',   15, 41, False, False, False),
  ('tnsp',  0, 16, False, False, False),
  ('rnsp',  0, 32, True,  False, False),
  ('nsp',   0, 16, True,  False, False),
  ('tnsp',  0, 32, False, True,  False),
  ('rnsp',  0, 20, False, False, True)
]
