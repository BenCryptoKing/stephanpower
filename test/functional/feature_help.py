...
"""Verify that starting stephanpower with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start stephanpower with -h for help text")
        ...
        self.log.info("Start stephanpower with -version for version information")
        ...
        self.log.info("Start stephanpowerd with -fakearg to make sure it does not start")
